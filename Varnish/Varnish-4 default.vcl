...
# wordpress Marker to tell the VCL compiler that this VCL has been adapted to the new 4.0 format.
vcl 4.0;
...
# The routine when we deliver the HTTP request to the user Last chance to modify headers that are sent to the client
sub vcl_deliver {
        if (obj.hits > 0) {
