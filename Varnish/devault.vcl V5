...
backend server1 { # Define one backend
  ...
  .max_connections        = 1000;    # Max number of connections allowed
...
###
  ...
  set beresp.ttl = 10m; # how long you cache objects
  ...
  # Allow stale content, in case the backend goes down.
  # make Varnish keep all objects for X TIME beyond their TTL
  set beresp.grace = 6h;
